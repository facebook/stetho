...
{% include ui/button.html button_href="https://github.com/facebook/stetho/releases/download/v1.4.0/stetho-1.4.0-fatjar.jar" button_text="Download v1.4.0" margin="small" align="center" %}
...
```groovy 
  dependencies { 
    compile 'com.facebook.stetho:stetho-okhttp:1.4.0' 
  } 
```
